...
#define ApplicationName 'EmergeNS'
#define ApplicationVersion GetStringFileInfo('Binaries/CI/App/EmergeNS.exe',"ProductVersion")

[Setup]
AppName={#ApplicationName}
AppId={#ApplicationName}
AppVersion={#ApplicationVersion}
AppPublisher=Denis Kuperberg
AppPublisherURL=https://perso.ens-lyon.fr/denis.kuperberg
