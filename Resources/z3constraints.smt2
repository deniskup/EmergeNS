...
(assert (=> ent0 (> (+ (ite reac0(- coef0) 0)
 (ite reac8(- coef8) 0)
 0) 0)))
(assert (=> ent1 (> (+ (ite reac3(- coef3) 0)
 (ite reac10(- coef10) 0)
 0) 0)))
(assert (=> ent2 (> (+ (ite reac2 (+ (- coef2) (- coef2)) 0)
 (ite reac6(- coef6) 0)
 (ite reac8(- coef8) 0)
 0) 0)))
...
(assert (=> ent4 (> (+ (ite reac1(- coef1) 0)
 (ite reac2 coef2 0)
 0) 0)))
(assert (=> ent5 (> (+ (ite reac8 coef8 0)
 (ite reac9 coef9 0)
 0) 0)))
(assert (=> ent6 (> (+ (ite reac0 coef0 0)
 (ite reac1 coef1 0)
 0) 0)))
(assert (=> ent7 (> (+ (ite reac1(- coef1) 0)
 (ite reac7(- coef7) 0)
 (ite reac9(- coef9) 0)
 0) 0)))
(assert (=> ent8 (> (+ (ite reac6 coef6 0)
 0) 0)))
(assert (=> ent9 (> (+ (ite reac7 coef7 0)
 0) 0)))
...
(assert (=> ent15 (> (+ (ite reac4(- coef4) 0)
 ...
 (ite reac11(- coef11) 0)
 0) 0)))
(assert (= (+ (ite ent0 1 0) (ite ent1 1 0) (ite ent2 1 0) (ite ent3 1 0) (ite ent4 1 0) (ite ent5 1 0) (ite ent6 1 0) (ite ent7 1 0) (ite ent8 1 0) (ite ent9 1 0) (ite ent10 1 0) (ite ent11 1 0) (ite ent12 1 0) (ite ent13 1 0) (ite ent14 1 0) (ite ent15 1 0)) 12))
(assert (= (+ (ite reac0 1 0) (ite reac1 1 0) (ite reac2 1 0) (ite reac3 1 0) (ite reac4 1 0) (ite reac5 1 0) (ite reac6 1 0) (ite reac7 1 0) (ite reac8 1 0) (ite reac9 1 0) (ite reac10 1 0) (ite reac11 1 0)) 12))
