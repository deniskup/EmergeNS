    ...
    Generation::Generation() : ControllableContainer("Generation")
{
    ...
    entitiesPerLevel = addIntParameter("Ents/level", "Entities per Level", 5,1, 50);
    maxReactionsPerEntity = addIntParameter("Reacs/entity", "Maximal number of reactions forming an entity",3, 1, 10);
